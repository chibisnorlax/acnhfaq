...
|:-:|-|
|<span><img src="https://faq.acnhapi.com/img/layout/DeviceIconPhoto^q.png" id="inv-icon"></span><br>**Camera**|Unlocked by default.<br/><br/>• **Pro Camera** - 1,500 <span class="icon-NM"></span><br/>Unlocks the first person, tripod, and bird's eye view camera views. Also unlocks several new camera filters.|
...
|<span><img src="https://faq.acnhapi.com/img/layout/DeviceIconClientList^q.png" id="inv-icon"></span><br>**Happy Home Network**|<span class="label label-red">DLC Only</span></br/>Unlocked by building your second vacation home on Paradise Planning.|
...
|<span><img src="https://faq.acnhapi.com/img/layout/DeviceIconShare^x.png" id="inv-icon"></span><br><b><span class="icon-Ex"></span> Rescue Service</b>|Unlocked by default. This app allows the player to teleport to pre-determined locations in exchange for miles if they are ever stuck.|
|<span><img src="https://faq.acnhapi.com/img/layout/DeviceIconTips^w_0.png" id="inv-icon"></span><br>**Island Life 101**|Unlocked by redeeming 400 <span class="icon-NM">. Periodically provides tips and tricks on the loading screen.|
